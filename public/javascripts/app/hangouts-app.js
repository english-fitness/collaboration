define(["jquery", "jquery-ui", "jquery.rating", "storm", "jquery.mousewheel", "jquery.mCustomScrollbar", "jquery.form", "jquery.slimscroll", "jquery.cookie",
    "pdfjs", "socket.io", "fabric","bootstrap", "storm.setup","mathquill"], function($, storm) {
