define(["storm", "storm.main", "storm.ui", "storm.util","math.util", "board.mouse", "underscore"], function (storm, main, ui, util,math, boardMouse, _) {
    ...
    return {
        ...
        vectorAction: function() {
            return '<div class="shape-holder lite" id="vector-shape" title="Geometry" data-shape="vector"><div class="basic-shape s-vector"></div></div>'; },

        /* mathTools*/

        mathTools: function() {
            return '<div class="shape-holder lite" id="math-shape"  title="Math" data-shape="math"><div class="basic-shape s-math"></div></div>';
        },
        asyncTool: function() {
            return '<div class="shape-holder lite" id="sync-shape" title="sync-async" data-shape="async"><div class="basic-shape s-sync">Async</div></div>';
        },
        ...
        createPallette: function (paletteName) {
            ...
            if('shapes' == paletteName) html = '<div class="shape-holder lite"  id="pointer-shape" data-shape="pointer" title="Select"><div class="basic-shape s-pointer"></div></div><div class="shape-holder lite" data-shape="click" title="Highlight Pointer"><div class="basic-shape s-click"></div></div>'+
                '<div class="shape-holder lite" id="highlight-shape" title="Markup" data-shape="highlight"><div class="basic-shape s-highlight"></div></div>';
            ...
            for (i in shapesObj.shapes) {
                ...
                shapeHolder = '<div class="shape-holder lite" id="'+shapeName+'-shape" title="'+shapeDisplayName+'" data-shape="'+shapeName+'"><div class="basic-shape s-'+shapeName+'"></div></div>';
                html += shapeHolder;
            }
            html += '<div class="shape-holder lite" id="eraser-shape" title="Eraser" data-shape="eraser"><div class="basic-shape s-eraser"></div></div></div>';
            // html +='</div>';
